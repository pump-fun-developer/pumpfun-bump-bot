...
https://github.com/user-attachments/assets/3386a73d-197c-4a6f-816c-fa7d47b40d1a
...
``` 
git clone https://github.com/pump-fun-developer/pumpfun-bump-bot.git
``` 
 
Else, you can download the repository in a zip here : https://github.com/pump-fun-developer/pumpfun-bump-bot/archive/refs/heads/master.zip
